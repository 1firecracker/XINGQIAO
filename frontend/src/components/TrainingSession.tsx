...
const TrainingSession: React.FC<TrainingSessionProps> = ({ 
  ...
  return (
    ...
    <div className="flex flex-col h-full space-y-6 animate-in fade-in duration-500">
      ...
      <button onClick={handleNext} className="w-full py-5 bg-[#E0F8E0] text-white rounded-[2rem] font-bold text-lg shadow-xl shadow-[#E0F8E0]/30 active:scale-[0.98] transition-all hover:bg-[#D0E8D0]">
